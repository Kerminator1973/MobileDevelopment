...
Android является операционной системой, базирующейся на модифицированном ядре Linux. Ядро форкнуто от mainline Linux (Android Common Kernel), init-система заменена на собственную (init.rc скрипты), нет GNU-утилит (вместо bash - **toybox**, а вместо glibc - **bionic**).
