...
Также пока не рассмотрены наиболее современные решения Microsoft в области кросс-платформенной разработки: Blazor и MAUI. Однако в моём репозитарии, посвещённом web-разработке есть несколько [статей](https://github.com/Kerminator1973/WebDevelopment/blob/master/blazor.md), посвящённых Blazor.
