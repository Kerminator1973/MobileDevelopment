...
В 2024 году важной технологией разработки мобильных приложений является [JetPack Compose](https://developer.android.com/develop/ui/compose) - продукт реализует декларативный стиль разработки ПО, в отличии от императивного стиля программирования, доминировавшего в предыдущие коды.
...
Наиболее современные решения Microsoft в области кросс-платформенной разработки: Blazor и MAUI. В моём репозитарии, посвещённом web-разработке есть несколько [статей](https://github.com/Kerminator1973/WebDevelopment/blob/master/blazor.md), посвящённых Blazor. Статья о [MAUI](./maui.md) также была добавлена в 2024 году.
