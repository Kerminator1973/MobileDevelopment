...
Альтернативным решением является использование облачных платформ, предлагающих сотни различных специализированных сервисов, от баз данных до хранилищ данных (S3). Лидерами на международном рынке являются компании Amazon (AWS), Microsoft (Azure) и Google (Goofle Cloud Platform).
